...
APP_NAME="${APP_NAME:-THE YVN CODE}"
APP_NAME_LC="$( echo "${APP_NAME}" | awk '{print tolower($0)}' )"
ASSETS_REPOSITORY="${ASSETS_REPOSITORY:-the-yvn/the-yvn-code}"
BINARY_NAME="${BINARY_NAME:-yvncode}"
GH_REPO_PATH="${GH_REPO_PATH:-the-yvn/the-yvn-code}"
ORG_NAME="${ORG_NAME:-THE YVN}"
