...
# Getting Started with THE YVN CODE

This guide will help you get started with THE YVN CODE.
...
THE YVN CODE can be installed on Windows, macOS, and Linux. Visit the [download page](https://github.com/the-yvn/the-yvn-code/releases) for installation instructions.

## <a id="first-steps"></a>First Steps

After installing THE YVN CODE, here are some first steps to get started:
...
THE YVN CODE works just like Visual Studio Code, with a few differences:
...
- Explore the [documentation](https://github.com/the-yvn/the-yvn-code/blob/master/docs/index.md) for more details
- Join the [community](https://github.com/the-yvn/the-yvn-code/discussions) to ask questions and share tips
- Contribute to the [project](https://github.com/the-yvn/the-yvn-code/blob/master/CONTRIBUTING.md) if you're interested
