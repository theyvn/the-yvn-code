...
Here is the base script to build THE YVN CODE:
...
- Linux: https://github.com/the-yvn/the-yvn-code/blob/master/.github/workflows/stable-linux.yml
- macOS: https://github.com/the-yvn/the-yvn-code/blob/master/.github/workflows/stable-macos.yml
- Windows: https://github.com/the-yvn/the-yvn-code/blob/master/.github/workflows/stable-windows.yml
...
- open `vscode` directory in a new **THE YVN CODE**'s window
- fix all the `*.rej` files
- run `npm run watch`
- run `./script/code.sh` until everything is ok
