...
export VSCODE_CLI_UPDATE_ENDPOINT="https://raw.githubusercontent.com/the-yvn/versions/refs/heads/master"

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/the-yvn/the-yvn-code-insiders/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/the-yvn/the-yvn-code/releases"
fi
